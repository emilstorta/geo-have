<template>
    ...
    <div class="fixed  bottom-0 left-0 right-0 bg-neutral-800">
        ...
        <div class="flex items-center justify-between mx-6 mt-6 mr-6" >
            ...
            <button @click="toggleHeart" class="text-gray-500 hover:text-orange-500 transition-colors duration-300">
                ...
                <svg v-else xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"
                    stroke="currentColor" class="h-6 w-6 text-orange-500">
                    <path
                        d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
                </svg>
            </button>
        ...
        <!-- Progress Bar -->
        <div class="m-6 bg-slate-500 h-1 rounded-full">
            <div class="bg-gray-200 h-1 rounded-full w-1/2"></div>
        </div>
        <!-- Time Information -->
        ...
        <div class="mt-2 mx-6 mr-6 mb-6 flex justify-center ">
            ...
            <!-- Play/Pause -->
            <button @click="togglePlay" class="play bg-white rounded-full size-20 mx-8 mr-8">
